...
export const childProperties: Readonly<Partial<Record<SyntaxKind, readonly (string | undefined)[]>>> = {
    ...
    [SyntaxKind.OperatorsDeclaration]: ["members"],
    [SyntaxKind.OperatorMethodDeclaration]: ["modifiers", "asteriskToken", "name", "postfixToken", "typeParameters", "parameters", "type", "body"],
