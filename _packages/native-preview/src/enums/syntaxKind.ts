...
(function (SyntaxKind) {
    ...
    SyntaxKind[SyntaxKind["OperatorsDeclaration"] = 284] = "OperatorsDeclaration";
    SyntaxKind[SyntaxKind["OperatorMethodDeclaration"] = 285] = "OperatorMethodDeclaration";
    SyntaxKind[SyntaxKind["ExternalModuleReference"] = 286] = "ExternalModuleReference";
    SyntaxKind[SyntaxKind["JsxElement"] = 287] = "JsxElement";
    SyntaxKind[SyntaxKind["JsxSelfClosingElement"] = 288] = "JsxSelfClosingElement";
    SyntaxKind[SyntaxKind["JsxOpeningElement"] = 289] = "JsxOpeningElement";
    SyntaxKind[SyntaxKind["JsxClosingElement"] = 290] = "JsxClosingElement";
    SyntaxKind[SyntaxKind["JsxFragment"] = 291] = "JsxFragment";
    SyntaxKind[SyntaxKind["JsxOpeningFragment"] = 292] = "JsxOpeningFragment";
    SyntaxKind[SyntaxKind["JsxClosingFragment"] = 293] = "JsxClosingFragment";
    SyntaxKind[SyntaxKind["JsxAttribute"] = 294] = "JsxAttribute";
    SyntaxKind[SyntaxKind["JsxAttributes"] = 295] = "JsxAttributes";
    SyntaxKind[SyntaxKind["JsxSpreadAttribute"] = 296] = "JsxSpreadAttribute";
    SyntaxKind[SyntaxKind["JsxExpression"] = 297] = "JsxExpression";
    SyntaxKind[SyntaxKind["JsxNamespacedName"] = 298] = "JsxNamespacedName";
    SyntaxKind[SyntaxKind["CaseClause"] = 299] = "CaseClause";
    SyntaxKind[SyntaxKind["DefaultClause"] = 300] = "DefaultClause";
    SyntaxKind[SyntaxKind["HeritageClause"] = 301] = "HeritageClause";
    SyntaxKind[SyntaxKind["CatchClause"] = 302] = "CatchClause";
    SyntaxKind[SyntaxKind["ImportAttributes"] = 303] = "ImportAttributes";
    SyntaxKind[SyntaxKind["ImportAttribute"] = 304] = "ImportAttribute";
    SyntaxKind[SyntaxKind["PropertyAssignment"] = 305] = "PropertyAssignment";
    SyntaxKind[SyntaxKind["ShorthandPropertyAssignment"] = 306] = "ShorthandPropertyAssignment";
    SyntaxKind[SyntaxKind["SpreadAssignment"] = 307] = "SpreadAssignment";
    SyntaxKind[SyntaxKind["EnumMember"] = 308] = "EnumMember";
    SyntaxKind[SyntaxKind["SourceFile"] = 309] = "SourceFile";
    SyntaxKind[SyntaxKind["JSDocTypeExpression"] = 310] = "JSDocTypeExpression";
    SyntaxKind[SyntaxKind["JSDocNameReference"] = 311] = "JSDocNameReference";
    ...
    SyntaxKind[SyntaxKind["JSDocUnknownTag"] = 324] = "JSDocUnknownTag";
    ...
    SyntaxKind[SyntaxKind["JSDocThrowsTag"] = 343] = "JSDocThrowsTag";
    SyntaxKind[SyntaxKind["JSDocSatisfiesTag"] = 344] = "JSDocSatisfiesTag";
    SyntaxKind[SyntaxKind["JSDocImportTag"] = 345] = "JSDocImportTag";
    SyntaxKind[SyntaxKind["SyntaxList"] = 346] = "SyntaxList";
    SyntaxKind[SyntaxKind["JSTypeAliasDeclaration"] = 347] = "JSTypeAliasDeclaration";
    ...
    SyntaxKind[SyntaxKind["FirstJSDocNode"] = 310] = "FirstJSDocNode";
    SyntaxKind[SyntaxKind["LastJSDocNode"] = 345] = "LastJSDocNode";
    SyntaxKind[SyntaxKind["FirstJSDocTagNode"] = 324] = "FirstJSDocTagNode";
